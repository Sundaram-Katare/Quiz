...
export default function LiveQuiz() {
    ...
    const handleJoin = async () => {
        ...
        setLoading(true);
        try {
            const resp = await axios.get(`http://localhost:3000/api/quiz/code/?code=${code}`);
            console.log(code);
        ...
        <>
            <div className="bg-gradient-to-r from-[#392a5c] to-[#030008] p-8 font-poppins">
                ...
                <div className="p-8 flex flex-col justify-center items-center">
                    ...
                    <img src="https://miro.medium.com/v2/resize:fit:1400/1*hPG_vJaKaaRnyyr6ipETnw.gif" className="mb-16" alt="" />
